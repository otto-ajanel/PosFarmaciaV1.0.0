...
class ControladorVentas
{
	...
	*/
	...
	=============================================*/
	static public function ctrDetalleVenta($valor)
	{

		$tabla = "detalle";
		$res = ModeloVentas::mdlDetalleVenta($tabla, $valor);
		return $res;
	}
	...
	static public function ctrEliminarVenta()
	{
		...
		if (isset($_GET["idVenta"])) {
			...
			==========================================================================*/
			$productos = ControladorVentas::ctrDetalleVenta($valor);
			...
			foreach ($productos as $key => $value) {
				...
				# code...
				$id = $value["CODIGO_INVENTARIO"];
				$tablaI = "inventario";
				$item = "CODIGO_INVENTARIO";
				$Inventario = ControladorInventario::ctrMostrarProductoInventario($item, $id);


				$nuevoStock = $Inventario["STOCK"] + $value["CANTIDAD"];

				$actulizarInventario = ModeloInventario::mdlActualizarInventario($tablaI, $tablaI, $tablaI, $id, $nuevoStock);
			}
			$tablaD = "detalle";
			$eliminarDetalle = ModeloVentas::eliminarDetalle($tablaD, $_GET["idVenta"]);
			/*=============================================
			ELIMINAR VENTA
			=============================================*/
	...
	/*=============================================
	RANGO FECHAS De ventas de productos
	=============================================*/
	static public function ctrRangoFechasVentasProductos($fechaInicial, $fechaFinal)
	{

		$tabla = "venta";
		$res = ModeloVentas::mdlRangoFechasVentasProductos($tabla, $fechaInicial, $fechaFinal);
	}
	static public function  crtProdcutosMasVendidos()
	{
		$tabla = "detalle";
		$res = ModeloVentas::mdlVentasProductosTop10($tabla);
		return $res;
	}
	...
	Mostrar detalle de una Venta:
	=============================================*/
	static public function ctrDetalleVentas($valor)
	{
	}
	/*=============================================
	SUMA TOTAL VENTAS

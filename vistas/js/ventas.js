...
function metodoEfectivo() {
	let val = $('#nuevoMetodoPago').val();
	if (val == "Efectivo") {

		$('#nuevoMetodoPago').parent().parent().removeClass("col-xs-6");

		$('#nuevoMetodoPago').parent().parent().addClass("col-xs-4");

		$('#nuevoMetodoPago').parent().parent().parent().children(".cajasMetodoPago").html(
...
BORRAR VENTA
=============================================*/
$(".tablas").on("click", ".eliminarVenta", function () {
...
$(".tablaVentasHoy").on("click", ".eliminarVenta", function () {
	...
	swal({
		...
		if (result.value) {
			...
			window.location = "index.php?ruta=crear-ventas&idVenta=" + idVenta;
		}
